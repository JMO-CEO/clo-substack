# Comic notes phase (CLO weekly)

Load clo-persuasion-coach Note template plus clo-comic-craft.

5 SEPARATE files note-1.md through note-5.md. Rotation: Mon Director, Tue Relator, Wed Intellectual, Thu Validator, Fri Executive.
One week villain across all 5 Notes. Hero roster as established, never a new permanent hero.
Each Note: under 400 chars ideal, max 600. COUNT the characters before saving. If over 600, cut until it fits.
