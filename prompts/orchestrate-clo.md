...
1. Research: 3 light tracks, 1 search each. (a) Legal AI authority (opinions, rulings, bar guidance). (b) AI systems and privacy posture. (c) Field practice from peer CLOs and legal ops. Write drafts/YYYY-MM-DD/research-brief.md with one cited line per item plus confidence note per track. The article must reference at least one item per track.
