...
Ship gate for week $ARGUMENTS (default today). Load the week drafts folder, run @clo-editor gate plus clo-publish-check, verify all 9 files present and non-empty.
